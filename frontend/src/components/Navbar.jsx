...
export default function Navbar() {
  ...
  return (
    <header className={active || pathname !== '/' ? 'bg-white text-black' : 'bg-green-800 text-white'}style={{transition : '0.5s all ease', position:'sticky',top : 0, display:'flex', flexDirection:'column',border:'none'}}>
