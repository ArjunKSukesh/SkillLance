            ...
            <div className="flex flex-wrap w-4/6 ">
              ...
              <div className=" mt-2 flex justify-center p-3 items-center w-9/12 rounded-lg overflow-hidden">
                  <div className=" flex  justify-center w-5/6 ">
                      ...
                      <input onChange={(e) => setinput(e.target.value)} type="text" placeholder="Try building mobile app..." className="w-full  p-3 text-black outline-none" />
                  </div>
                  <button className="bg-green-600 p-3.5 rounded-r-lg font-semibold text-xl" onClick={handleSubmit}>Search</button>
              </div>
